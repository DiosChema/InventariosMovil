...
class DialogAgregarArticulos : AppCompatDialogFragment(){
    ...
    fun crearDialogArticulos(context: Context, globalVariableTmp: GlobalClass, activity : Activity){
        ...
        dialogArticulosSalir = dialogInstance.findViewById(com.example.perraco.R.id.dialogArticulosSalir) as ImageButton
        mRecyclerViewArticulos = dialogInstance.findViewById(com.example.perraco.R.id.dialogoArticulosRecyclerView) as RecyclerView
    ...
    fun showDialogAgregarArticulo() {
        ...
        dialogAgregarArticuloAceptar.setOnClickListener {
            ...
            if(dialogAgregarArticuloCodigo.text.isNotEmpty() && dialogAgregarArticuloCantidad.text.isNotEmpty()) {
                var codigoTmp = parseLong(dialogAgregarArticuloCodigo.text.toString())
                var cantidadTmp = Integer.parseInt(dialogAgregarArticuloCantidad.text.toString())
