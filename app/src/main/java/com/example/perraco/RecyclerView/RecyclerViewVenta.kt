...
class RecyclerViewVenta : RecyclerView.Adapter<RecyclerViewVenta.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(venta: InventarioObjeto, context: Context) {
            ...
            itemSurtidoArticuloPrecio.text = "$" +venta.precioArticulo.toString()
            ...
            itemSurtidoArticuloTotal.text = itemView.context.getString(R.string.venta_total) + (venta.precioArticulo * venta.cantidadArticulo).toString()
